...
class error
{
    ...
    public function triggerError() {
        ...
        $body = '<h1>Connection issue request/response to TVDB server (' . $this->getResponseCode() . ')</h1>
        ...
        ';
        \Drupal::logger('epg tvdb')->error($body);
        // Trigger an official error as well
        $messenger = \Drupal::messenger();
        $messenger->addError('TVDB Error: ' . $this->getErrorMessage());
    }
